        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              >
                Welcome to Yay: Your Engineering Haven
              </h2>
              <p
              ...
              >
                Dive into the world of engineering and development with insights, tips, and stories from an industry expert. Let's create and innovate together!
              </p>
            </div>
            <dl
