...
export default function Page() {
  return (
    <main className={`h-full overflow-y-auto`}>
        ...
        <BannerWithButton theme={config.theme} />
    
        <NavbarSimple theme={config.theme} />
    
        <HeroWithOffsetImage theme={config.theme} />
    
        <TestimonialsGrid theme={config.theme} />
    
        <StatsSimpleGrid theme={config.theme} />
    
        <CtaSimpleCentered theme={config.theme} />
    
        <FaqsOffsetWithSupportingText theme={config.theme} />
    
        <NewsletterCenteredCard theme={config.theme} />
    
        <FooterSimpleCentered theme={config.theme} />
